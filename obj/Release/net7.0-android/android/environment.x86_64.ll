...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"266f1877-bc80-4473-ae36-34da71721031\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [22 x i8] c"com.companyname.ficym\00", align 16
...
@__DSOCacheEntry_name.33 = internal constant [20 x i8] c"libaot-ficym.dll.so\00", align 16
...
@dso_cache = local_unnamed_addr global [560 x %struct.DSOCacheEntry] [
	...
	; 33
	%struct.DSOCacheEntry {
		i64 1186702802614239442, ; hash 0x107803e95bc840d2, from name: libaot-ficym.dll.so
		i8 0, ; ignore
	...
	; 53
	%struct.DSOCacheEntry {
		i64 2160733187041404190, ; hash 0x1dfc7762b400251e, from name: libaot-ficym
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.33, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 93
	%struct.DSOCacheEntry {
		i64 3393987459966200118, ; hash 0x2f19dd9cdb6a6936, from name: aot-ficym.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.33, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 121
	%struct.DSOCacheEntry {
		i64 4326183104969722141, ; hash 0x3c09b09ce504491d, from name: aot-ficym
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.33, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 150
	%struct.DSOCacheEntry {
		i64 5433527036908940245, ; hash 0x4b67c40d50702bd5, from name: ficym
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.33, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 358
	%struct.DSOCacheEntry {
		i64 11960092990700283086, ; hash 0xa5fac9352f5464ce, from name: ficym.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.33, i32 0, i32 0), ; name
		i8* null; handle
	}, 
