...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"266f1877-bc80-4473-ae36-34da71721031\00", align 1
...
@__ApplicationConfig_android_package_name.0 = internal constant [22 x i8] c"com.companyname.ficym\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33555283, ; android_runtime_jnienv_class_token
	i32 100672382, ; jnienv_initialize_method_token
	i32 100672381, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.33 = internal constant [58 x i8] c"libaot-Microsoft.Extensions.FileProviders.Physical.dll.so\00", align 1
...
@__DSOCacheEntry_name.36 = internal constant [54 x i8] c"libaot-Microsoft.AspNetCore.Components.WebView.dll.so\00", align 1
...
@__DSOCacheEntry_name.44 = internal constant [20 x i8] c"libaot-ficym.dll.so\00", align 1
...
@dso_cache = local_unnamed_addr global [560 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([58 x i8], [58 x i8]* @__DSOCacheEntry_name.33, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 41
	%struct.DSOCacheEntry {
	...
	; 56
	%struct.DSOCacheEntry {
		i64 477593388, ; hash 0x1c777f2c, from name: libaot-ficym
		i8 0, ; ignore
	...
	; 215
	%struct.DSOCacheEntry {
		i64 1759208781, ; hash 0x68db654d, from name: aot-ficym.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 324
	%struct.DSOCacheEntry {
		i64 2492806758, ; hash 0x94953666, from name: ficym
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 355
	%struct.DSOCacheEntry {
		i64 2713349195, ; hash 0xa1ba6c4b, from name: libaot-ficym.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 444
	%struct.DSOCacheEntry {
		i64 3301505192, ; hash 0xc4c8f8a8, from name: aot-ficym
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	...
	; 488
	%struct.DSOCacheEntry {
		i64 3677950739, ; hash 0xdb391313, from name: ficym.dll.so
		i8 0, ; ignore
		i8* getelementptr inbounds ([20 x i8], [20 x i8]* @__DSOCacheEntry_name.44, i32 0, i32 0), ; name
		i8* null; handle
	}, 
